...
# -*- coding: utf-8 -*-
"""
Analise simples do banco de dados BTC
"""
...
def check_db():
    ...
    print("=" * 60)
    print("ANALISE DO BANCO DE DADOS BTC")
    print("=" * 60)
    ...
    # 6. Verificar se ha sinais mas sem trades
    ...
    if sinais_sem_trades > 0:
        print(f"   ATENCAO: {sinais_sem_trades} sinais sem trades correspondentes (ultima hora)")
    
    # Verificar se agente esta gerando sinais
    cursor.execute('''
    ...
    if ultimo_sinal:
        ...
        print(f"   Ultimo sinal: {minutos_desde:.1f} minutos atras")
        
        if minutos_desde > 30:
            print(f"   ATENCAO: Sem sinais ha {minutos_desde:.1f} minutos!")
    
    # 7. Performance por razao
    print("\nPERFORMANCE POR RAZAO:")
    cursor.execute('''

...
class GoldLossZeroSimple:
    ...
    def __init__(
        ...
        stop_loss_atr_multiplier: float = 1.5,  # GOLD: SL = ATR × 1.5 (mais conservador)
        trailing_activation_atr_multiplier: float = 0.4,  # GOLD: ATR × 0.4
    ...
    def _calculate_point_value(self):
        ...
        try:
            ...
            if symbol_info:
                ...
                self.point_value = 1.0  # $1 por ponto para 1 lote
    ...
    def _calculate_atr_simple(self, rates) -> float:
        ...
        try:
            if len(rates) < 14:
                return 60.0  # GOLD: ATR padrão 60 pontos

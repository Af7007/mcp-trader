...
URGENTE: Acelerar abertura de posicoes para testar trailing

CORRECOES:
- Reduzir todos os thresholds pela METADE
- Eliminar filtros conservadores
- Cooldown minimo (5 segundos)
- Momentum ultra-flexivel
- Volume um pouco maior para movimentos mais rapidos
"""
...
class GoldAdaptiveAgentUltraAgressivoTrailing(GoldLossZeroSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        kwargs.update({
            ...
            # Volume maior para movimentos mais rapidos
        ...
        try:
            ...
            while True:
                ...
                if time.time() - start_time > 1800:  # 30 min
                    print(f"\n[STOP] Teste de 30 minutos concluido!")

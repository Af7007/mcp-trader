...
def fix_game_interface():
    ...
    print("\n1. Verificando trades com profit = 0.0...")
    cursor.execute("""
    ...
    print("\n2. Verificando trades com tipo UNKNOWN...")
    cursor.execute("""
    ...
    for issue in encoding_issues:
        ...
        print(f"   Trade #{ticket} - Timestamp problematico: {close_time}")
    
    # 5. Sugerir correções
    print("\n5. CORRECOES SUGERIDAS:")
